...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('jain.garima88@gmail.com');
    setHasCopied(true);
              ...
              <div className="grid-container">
                <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
                  <Globe
                    ...
                    labelsData={[{ lat: 1.4332513, lng: 103.7874458, text: 'I am here', color: 'white', size: 15 }]}
                  />
                </div>
                <div>
          ...
          <div className="grid-container">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">jain.garima88@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
